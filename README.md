...
functions. AutoTab has been developed and tested with TensorFlow 2.13.0.
Other versions may work, but compatibility is not guaranteed.

AutoTab was developed under Python 3.11.15 and numpy 1.26.4. If
...
Tabular Data. R package version 1.1 <doi:10.32614/CRAN.package.autotab>.
